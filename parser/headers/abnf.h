...
void content_length(char **current_char, node *struct_current);
void content_type(char **current_char, node *struct_current);
void cookie(char **current_char, node *struct_current);
void transfer_encoding(char **current_char, node *struct_current);
void expect(char **current_char, node *struct_current);